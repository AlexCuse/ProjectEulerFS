...
let solve = 
    ...
    for y in 0..19 do
        for x in 0..19 do
            yield vertProduct x y
            yield horizProduct x y
            yield diagRightProduct x y 
            yield diagLeftProduct x y
    }
    |> Seq.max